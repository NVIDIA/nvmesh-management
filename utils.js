...
scope.getVRPartsObj = (versionRelease) => {
...
scope.compareVersionRelease = (vr1, vr2) => {
	var vr1PartsObj = scope.getVRPartsObj(vr1);
	var vr2PartsObj = scope.getVRPartsObj(vr2);
...
scope.volumeProjection = {
	...
	'mdvUUID': 1,
	'metaCdvUUID': 1,
	'metaCdvExtentSizeMib': 1,
	'metaTpvExtentSizeKb': 1,
	'isEncrypted': 1,
