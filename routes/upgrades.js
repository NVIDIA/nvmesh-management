 ...
 * @apiParam {object} upgrade `Upgrade` to create.
 * @apiParam {string} upgrade.destinationVersion `Destination version` of the `Upgrade`.
 * @apiParam {string[]} upgrade.machinesToUpgrade `Machines to upgrade` of the `Upgrade`.
 * @apiParam {string} [upgrade.executionMode=automatic] `Execution mode` of the `Upgrade`.
 * <small><i>Options: `automatic`, `manualStart`, `manual`</i></small>.
 * @apiParam {string} [upgrade.minRedundancyLevel=max] `Minimum redundancy level` of the `Upgrade`.
 * <small><i>Options: `max`, `minimum`, `none`</i></small>.
 * @apiParam {boolean} [upgrade.skipMachinesOnFailure=false] `Skip machines on failure` of the `Upgrade`.
 * @apiParam {number} [upgrade.maxErrorsThreshold=1] `Max errors threshold` of the `Upgrade`.
 * @apiParam {number} [upgrade.maxConcurrentClients=1] Maximum amount of clients that can be upgraded concurrently.
...
/**
 * @apiVersion 1.0.0
 * @api {get} /upgrades/getPossibleUpgrades?isClientOnly={}&sourceVersion={} Get possible upgrades
 * @apiName GetPossibleUpgrades
 * @apiGroup upgrades
 * @apiDescription Get possible upgrades for a given source version.
 *
 * @apiParam {boolean} isClientOnly Whether the upgrade is client only.
 * @apiParam {string} sourceVersion The source version to get possible upgrades for.
 *
 ...
 * @apiParam {object[]} upgrades `Upgrades` to delete.
 ...
 *
 * @apiParam {string} upgrade `upgrade's ID` to fetch.
 ...
 * @apiParam {object} upgrade `Upgrade` to start.
 * @apiParam {string} [upgrade._id] `ID` of the `Upgrade`.
 * @apiParamExample {string} Payload example
 * {
 *	_id: 'f02abf10-6bfb-11ed-a62f-d1b4ca08eefb'
 * }
 ...
 * @apiParam {object} upgrade `Upgrade` to resume.
 * @apiParam {string} [upgrade._id] `ID` of the `Upgrade`.
 * @apiParamExample {string} Payload example
 * {
 *	_id: 'f02abf10-6bfb-11ed-a62f-d1b4ca08eefb'
 ...
 * @apiParam {object} upgrade `Upgrade` to skip.
 * @apiParam {string} [upgrade._id] `ID` of the `Upgrade`.
 * @apiParamExample {string} Payload example
 * {
 *	_id: 'f02abf10-6bfb-11ed-a62f-d1b4ca08eefb'
