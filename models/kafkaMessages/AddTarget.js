...
exports.AddTarget = class AddTarget extends KafkaMessage {
	constructor(nodeID, nodeUUID, targetsInZone, targetUpdatesSequence, type = kafkaMessageTypes.ManagementToTOMA.addTarget, version = 1) {
		super(type, version);
